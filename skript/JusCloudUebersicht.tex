...
\RedeclareSectionCommand[beforeskip=12pt,runin=false, afterskip=-2pt]{section}
\RedeclareSectionCommand[beforeskip=6pt,runin=false, afterskip=-4pt]{subsection}
...
\includepdf[pages={1-},width=\textwidth]{pdf/DSK_KPNr_7_Marktortprinzip.pdf}
